  ...
  return (
    <div className="w-full bg-gray-100 py-16">
      <div className="max-w-[1240px] mx-auto flex flex-col px-4">
        ...
        <p className="sm:flex sm:flex-col text-center justify-between items-center">Copyright © 2023 TravelApp Developed by&nbsp;<a href="https://sosamson.com" target = "_blank" 
            rel = "noopener noreferrer">Sosamson</a>. All rights reserved.</p>
        </div>
    </div>
  );
};
